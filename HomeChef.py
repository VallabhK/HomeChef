...
from dataProcessing import getCalorieData, youTubeSearch
...
class Ui_Form(object):
    ...
    def searchButtonClicked(self):
        ...
        if (len(searchString) > 0):
            ...
            recipeInformation, recipes = get_recipe(searchString)
            self.RecipeInformation.setText(recipeInformation)

            recipeList = youTubeSearch(recipes)
            ...
            for recipe in recipes:
                #self.Recipe1Label.setText(linkTemplate.format("", recipes[[1][0]]))
                self.Recipe1Label_2.setText(linkTemplate.format("https://Google.com", "Google.com"))
                self.Recipe1Label_3.setText(linkTemplate.format("https://Google.com", "Google.com"))
